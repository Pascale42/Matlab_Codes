...
%
%Evgeny: i had 2 modifications in the lines 255 and 662 to fix errors, which appear in matlab R2014b becaue of a new non-numeric format 
%        of line handles. If you experience any problems with these changes, pls let me know.
%Javier: To avoid problems with scribefiglisten(fig,'off'); function when
%toggle off the zoom mode I just commented the line 890
...
%            fprintf('%s %s\n',whatbutton,buttontype);
        ...
        case 'traces'
            ...
            if ~FileExists([gCheckEegStates.FileBase '.lfp']) && FileExists([gCheckEegStates.FileBase '.dat'])
                Seg = LoadSegs([gCheckEegStates.FileBase '.dat'],segbeg,seglen,gCheckEegStates.Par.nChannels,...
            ...
            xlabel('Time, (sec)')
            title(sprintf('LFP signal from ch-%d',  gCheckEegStates.Channels) )
