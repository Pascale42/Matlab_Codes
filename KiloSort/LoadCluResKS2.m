...
function [T, G, Map] = LoadCluResKS2(varargin)
% function [T, G, Map] = LoadCluResKS(SamplingRate, Save)
%
...
[SamplingRate, Save] = DefaultArgs(varargin,{[], 0});
