function [tsOffsets, ts1idx, ts2idx] = crosscorrelogram(ts1, ts2, window)
    ...
    %
    % Copyright (c) 2010, Alex Wiltschko; All rights reserved.
    % from http://freesourcecode.net/matlabprojects/67045/discrete-time-cross-correlogram-in-matlab#.VbjsB3hMOgE
    ...
    %%% Pascale
    tsOffsets=tsOffsets*1000;% sinon c'est en secondes!
